...
class MethodChannelWiFiForIot extends WiFiForIoTPlugin {
  final MethodChannel _channel = const MethodChannel('wifi_iot');
  @Deprecated(
  ...
  Future<List<WifiNetwork>> loadWifiList() async {
    ...
    result.clear();
    return await WiFiForIoTPlugin.instance.onWifiScanResultReady.first;
  }
